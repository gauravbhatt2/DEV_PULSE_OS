...
interface BattlePlanCardProps {
  ...
  onContext: (task: BattlePlanItem) => void;
...
export function BattlePlanCard({ task, onAction, onContext, busyTaskKey, busyAction, isHovered, onHover }: BattlePlanCardProps) {
    ...
    >
      ...
      <div className="flex gap-2 flex-wrap mt-1">
        ...
        <button
          ...
          disabled={isBusy}
          className="ml-auto bg-indigo-50 border border-indigo-200 text-indigo-600 px-3 py-1.5 rounded-lg font-semibold text-xs transition-colors hover:bg-indigo-100 disabled:opacity-50 flex items-center gap-1"
        >
